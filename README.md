...
Focus on people, not on technical details and lots of features. There are many ways to become active in our community. Think about what you want to do and what would make life easier. Improve the available extensions and make them more useful. [Tips for working together](https://github.com/datenstrom/community/discussions/760) and [API for developers](https://datenstrom.se/yellow/help/api-for-developers).
